...
result1 <- read.csv("E:/阴性对照/Simulation/20200206/not_equal/result_cor1_case1_nocausal_20200204.csv",stringsAsFactors =F)
result1 <- result1[,-1]

result2 <- read.csv("E:/阴性对照/Simulation/20200206/not_equal/result_cor1_case2_nocausal_20200204.csv",stringsAsFactors =F)
result2 <- result2[,-1]

result3 <- read.csv("E:/阴性对照/Simulation/20200206/not_equal/result_cor1_case3_nocausal_20200204.csv",stringsAsFactors =F)
result3 <- result3[,-1]

################################## g ###############
pdf("noequal_nocausal_cor1.pdf",width =9,height = 4)
par(mfrow=c(1,3))
#bias
...
plot(result1$cor1,result1$POWER_ivw,type="o",col="tomato",lty=1,pch=16, 
     xlab="correlation among NCs", ylab="Type I error rate",ylim=c(-0.3,1))
...
result1 <- read.csv("E:/阴性对照/Simulation/20200206/not_equal/result_cor1_case1_20200204.csv",stringsAsFactors =F)
result1 <- result1[,-1]

result2 <- read.csv("E:/阴性对照/Simulation/20200206/not_equal/result_cor1_case2_20200204.csv",stringsAsFactors =F)
result2 <- result2[,-1]

result3 <- read.csv("E:/阴性对照/Simulation/20200206/not_equal/result_cor1_case3_20200204.csv",stringsAsFactors =F)
result3 <- result3[,-1]

################################## g ###############
pdf("noequal_cor1.pdf",width =9,height = 4)
par(mfrow=c(1,3))
#bias
plot(result1$cor1,result1$bias_ivw,type="o",col="tomato",lty=1,pch=16, 
     xlab="correlation among NCs", ylab="Bias",ylim=c(-0.1,0.3))
