...
rere <- main(NN=1000,g=20,b=0.5,d=0.5,c=0,sigma1=4,sigma2=1,sigma_x=0.0001,cor1=0,cor2=0)
...
for(i in 1:length(cor2)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=0,sigma1=1,sigma2=1,sigma_x=0.0001,cor1=0.2,cor2=cor2[i])
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
...
result1 <- NULL
for(i in 1:length(g)){
  result <- main(NN=1000,g=g[i],b=0.5,d=0.5,c=0,sigma1=1,sigma2=1,sigma_x=0.0001,cor1=0.2,cor2=0)
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
...
result1 <- NULL
for(i in 1:length(cor2)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=2,sigma1=1,sigma2=1,sigma_x=0.0001,cor1=0.2,cor2=cor2[i])
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
...
result1 <- NULL
for(i in 1:length(g)){
  result <- main(NN=1000,g=g[i],b=0.5,d=0.5,c=2,sigma1=1,sigma2=1,sigma_x=0.0001,cor1=0.2,cor2=0)
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
