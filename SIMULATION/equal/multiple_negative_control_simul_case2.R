...
DataGenerator <- function(g,b,d,c,sigma1,sigma2,sigma_y,cor1,cor2){
  
  gamma_y <- rnorm(g,4,sigma_y)
    
  a <- rep(0.5,g)
  M <- matrix(c(b*a,d*a*(1-b^2)/(1-(b*a)^2)+gamma_y),ncol=2)
...
main <- function(NN,g,b,d,c,sigma1,sigma2,sigma_y,cor1,cor2){
  ...
  b2 <- NULL
	...
	for(i in 1:NN){
		...
		fdata0 <- DataGenerator(g,b,d,c,sigma1,sigma2,sigma_y,cor1,cor2)
		fdata <- fdata0[[1]]
...
rere <- main(NN=1000,g=20,b=0.5,d=0.5,c=0,sigma1=4,sigma2=1,sigma_y=0.001,cor1=0.15,cor2=0)
...
for(i in 1:length(cor1)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=0,sigma1=4,sigma2=1,sigma_y=0.001,cor1=cor1[i],cor2=0)
...
write.csv(result1,"result_cor1_case2_nocausal_20200204.csv")
...
for(i in 1:length(cor2)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=0,sigma1=4,sigma2=1,sigma_y=0.001,cor1=0.15,cor2=cor2[i])
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                       "se_ivw","se_egger", "mse_ivw","mse_egger",
...
write.csv(result1,"result_cor2_case2_nocausal_20200204.csv")
...
result1 <- NULL
for(i in 1:length(g)){
  result <- main(NN=1000,g=g[i],b=0.5,d=0.5,c=0,sigma1=4,sigma2=1,sigma_y=0.001,cor1=0.15,cor2=0)
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                       "se_ivw","se_egger", "mse_ivw","mse_egger",
...
write.csv(result1,"result_g_case2_nocausal_20200204.csv")
...
result1 <- NULL
for(i in 1:length(cor1)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=2,sigma1=4,sigma2=1,sigma_y=0.001,cor1=cor1[i],cor2=0)
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                       "se_ivw","se_egger", "mse_ivw","mse_egger",
                       ...
                       "bias_ivw2","bias_egger2", "se_ivw2","se_egger2")
result1 <- cbind(cor1,result1)
write.csv(result1,"result_cor1_case2_20200204.csv")
...
result1 <- NULL
for(i in 1:length(cor2)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=2,sigma1=4,sigma2=1,sigma_y=0.001,cor1=0.15,cor2=cor2[i])
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                       "se_ivw","se_egger", "mse_ivw","mse_egger",
                       ...
                       "bias_ivw2","bias_egger2", "se_ivw2","se_egger2")
result1 <- cbind(cor2,result1)
write.csv(result1,"result_cor2_case2_20200204.csv")
...
result1 <- NULL
for(i in 1:length(g)){
  result <- main(NN=1000,g=g[i],b=0.5,d=0.5,c=2,sigma1=4,sigma2=1,sigma_y=0.001,cor1=0.15,cor2=0)
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                       "se_ivw","se_egger", "mse_ivw","mse_egger",
                       ...
                       "bias_ivw2","bias_egger2", "se_ivw2","se_egger2")
result1 <- cbind(g,result1)
write.csv(result1,"result_g_case2_20200204.csv")
