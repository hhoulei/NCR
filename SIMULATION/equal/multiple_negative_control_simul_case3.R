...
DataGenerator <- function(g,b,d,c,sigma1,sigma2,sigma_x,cor1,cor2){
  
  gamma_x <- rnorm(g,1,sigma_x)
  
  a <- rep(0.5,g)
  M <- matrix(c(b*a+gamma_x,d*a*(1-b^2)/(1-(b*a+gamma_x)^2)),ncol=2)
  ...
  b0 <- 0
  beta_YG <- b0 + c*beta_XG + (1-(b*a+gamma_x)^2)/(1-b^2) * beta_WY_X + rnorm(g,0,1)
  
  datasimul <- list(data.frame(betaYG=beta_YG, betaWY_X=beta_WY_X,betaXG=beta_XG),
                    b0=mean(b0),
                    b2=mean((1-(b*a+gamma_x)^2)/(1-b^2)))
  return(datasimul)
}


main <- function(NN,g,b,d,c,sigma1,sigma2,sigma_x,cor1,cor2){
  ...
  b2 <- NULL
	...
	for(i in 1:NN){
		...
		fdata0 <- DataGenerator(g,b,d,c,sigma1,sigma2,sigma_x,cor1,cor2)
		fdata <- fdata0[[1]]
...
rere <- main(NN=1000,g=20,b=0.5,d=0.5,c=0,sigma1=4,sigma2=1,sigma_x=0.001,cor1=0,cor2=0)
...
sigma1 <- c(0.001,0.01,0.1,1,2,3,4,5)
result1 <- NULL
for(i in 1:length(sigma1)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=0,sigma1=sigma1[i],sigma2=1,sigma_x=0.001,cor1=0,cor2=0)
...
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 ...
                 "CIW_ivw","CIW_egger","beta_ivw2","beta_egger2",
                 "bias_ivw2","bias_egger2", "se_ivw2","se_egger2")
result1 <- cbind(sigma1,result1)
write.csv(result1,"result_sigma1_case3_nocausal_20200204.csv")

#######################################################################

sigma_x <- c(0.0001,0.001,0.01,0.1,1,2,3,4,5)
result1 <- NULL
for(i in 1:length(sigma_x)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=0,sigma1=1,sigma2=1,sigma_x=sigma_x[i],cor1=0,cor2=0)
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
                 ...
                 "CIW_ivw","CIW_egger","beta_ivw2","beta_egger2",
                 "bias_ivw2","bias_egger2", "se_ivw2","se_egger2")
result1 <- cbind(sigma_x,result1)
write.csv(result1,"result_sigma_x_case3_nocausal_20200204.csv")
...
for(i in 1:length(cor1)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=0,sigma1=1,sigma2=1,sigma_x=0.0001,cor1=cor1[i],cor2=0)
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
...
write.csv(result1,"result_cor1_case3_nocausal_20200204.csv")
...
for(i in 1:length(cor2)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=0,sigma1=1,sigma2=1,sigma_x=0.0001,cor1=0,cor2=cor2[i])
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
...
write.csv(result1,"result_cor2_case3_nocausal_20200204.csv")
...
result1 <- NULL
for(i in 1:length(g)){
  result <- main(NN=1000,g=g[i],b=0.5,d=0.5,c=0,sigma1=1,sigma2=1,sigma_x=0.0001,cor1=0,cor2=0)
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
...
write.csv(result1,"result_g_case3_nocausal_20200204.csv")
...
result1 <- NULL
for(i in 1:length(cor1)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=2,sigma1=1,sigma2=1,sigma_x=0.0001,cor1=cor1[i],cor2=0)
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
                 ...
                 "bias_ivw2","bias_egger2", "se_ivw2","se_egger2")
result1 <- cbind(cor1,result1)
write.csv(result1,"result_cor1_case3_20200204.csv")
...
result1 <- NULL
for(i in 1:length(cor2)){
  result <- main(NN=1000,g=20,b=0.5,d=0.5,c=2,sigma1=1,sigma2=1,sigma_x=0.0001,cor1=0,cor2=cor2[i])
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
                 ...
                 "bias_ivw2","bias_egger2", "se_ivw2","se_egger2")
result1 <- cbind(cor2,result1)
write.csv(result1,"result_cor2_case3_20200204.csv")
...
result1 <- NULL
for(i in 1:length(g)){
  result <- main(NN=1000,g=g[i],b=0.5,d=0.5,c=2,sigma1=1,sigma2=1,sigma_x=0.0001,cor1=0,cor2=0)
  result1 <- rbind(result1,result)
}
colnames(result1) <- c("c","b0","beta_ivw","beta_egger","bias_ivw","bias_egger",
                 "se_ivw","se_egger", "mse_ivw","mse_egger",
                 ...
                 "bias_ivw2","bias_egger2", "se_ivw2","se_egger2")
result1 <- cbind(g,result1)
write.csv(result1,"result_g_case3_20200204.csv")
